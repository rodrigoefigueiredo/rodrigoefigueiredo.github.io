# GERENCIAMENTO DE TEMPO PARA ALTO DESEMPENHO
...
## VALORAÇÃO, PRIORIZAÇÃO E ORGANIZAÇÃO DE ATIVIDADES

### LISTA DE PRIORIDADES
    Com muitas atividades a serem realizadas é importante fazer uma lista de prioridades.
    Prioriza e vai executando a lista, item a item, ou talvez dois ou mais ao mesmo tempo quando for possível.
    Gerenciar tempo não é só fazer lista de prioridades, porém é o primeiro passo porque precisa ter foco.
    Priorizar é importante porque caso contrário tentará fazer tudo ao mesmo tempo, e não vai concluir, ou vai fazer desordenado, fazendo o menos importante primeiro deixando o importante sem fazer.
    Gerenciamos itens limitados, como o tempo. Se fosse ilimitado não precisaria gerenciar.
    Primeiro item na priorização é definir o que quero e o que preciso.
    O que Quero vs O que preciso
        - O que eu preciso é prioridade maior do que o que eu quero.
        - Separar quais eu quero e quais preciso executar.
        - Quero ler, mas preciso trabalhar, logo, trabalhar é mais importante e vai para o topo da lista.
        - Escassez: Tudo que é limitado precisa ser gerenciado.
    Podemos usar o dinheiro para comprar tempo de terceiros, mas o dinheiro pode ser mais limitado que o tempo, logo, a própria pessoa vai ter que fazer, e vai precisar ter uma lista de prioridades.
    Se não priorizar vai se perder em atividades e não vai chegar a lugar nenhum.
        - Tentar fazer tudo ao mesmo tempo e se perder.
    Definir o que precisa fazer primeiro. Os itens mais difíceis, ou os mais fáceis para já eliminá-los da lista?

### DANDO VALORES APROXIMADOS ÀS ATIVIDADES

    Como definir o valor de uma atividade para criar a lista corretamente ordenada?
    Não dá para priorizar itens que não tem "preço".
        Qual é mais relevante?
        Qual gasta menos tempo?
        Qual gasta menos dinheiro?
        Preciso gastar dinheiro para realizar o item? Tenho este valor? Se não, vou ter que começar por itens mais simples
    Às vezer é difícil determinar o preço de uma atividade, então posso atribuir uma nota, ou uma avaliação simples:
        Muito Importante, Importante, Médio, Menos Importante
        Nota de 1 a 5
    O importante é estabelecer um critério.
        Com pouco recurso financeiro, o critério pode ser o mais barato ser o mais importante
        Com pouco tempo, o critério é o que ocupa menos o meu tempo.
        O mais barato, o que é mais caro, o que gera mais lucro
        Há coisas que preciso fazer hoje, porque amanhã pode ser tarde, mas se esta atividade for irrelevante posso descartar.
        Fazer lista de prioridades com itens relevantes.
        Todo não para uma atividade é um sim para outra atividade mais relevante.
            Não para o menos relevante
            Sim para o mais relevante
            Todo Não carrega um Sim. E todo Sim carrega vários Nãos.
        Como dar nota, preço ou avaliação para uma atividade?
            Tenha critério e avalie de acordo com o critério estabelecido.
            Para algumas atividades falar Sim e para outras falar Não.
            Dicas:
                Dê nota ZERO para todas atividades irrelevantes: corte tudo o que não é relevante.
                Faça o mais rápido e mais urgente.
                Se uma atividade pode esperar, mas envolve o conjuge é melhor dar prioridade máxima, mesmo se tiver uma outra atividade urgente.
                Avaliar:
                    - Atividades para daqui há 10 dias, com baixo potencial de retorno.
                    - Atividades para daqui há 3 anos, com alto potencial de retorno
                        -> Reavaliar para encaixar estas atividades, mesmo que dividindo-a em pequenas ativides. 
                        Sempre arrume tempo para atividades com alto potencial de retorno, mesmo não sendo urgentes.
                Envolva o conjuge para aumentar desempenho.
                Se tiver dinheiro e puder comprar um equipamento que aumente o desempenho, compre-o urgentemente.
                Se tiver dinheiro terceirize atividades ou contrate uma equipe para ampliar seu tempo.
                    Ter uma equipe aumenta capacidade de desenvolver projetos complexos e que demandam mais tempo.
                Tome cuidade com os efeitos colaterais de suas decisões:
                    Se a esposa ajuda muito o marido terá menos tempo para os filhos.
                    O marido que ajuda muito a esposa terá menos tempo para ganhar dinheiro.
                    Um funcionário contratado pode te processar.
